...
Drzewa decyzyjne są często łączone w komitety klasyfikatorów \angterm{ensemble methods}. Wiele "słabych" klasyfikatorów jest łączonych w jeden "silny" na dwa sposoby: workowania \angterm{bagging} oraz wzmacniania \angterm{boosting}, które są często ze sobą porównywane.
