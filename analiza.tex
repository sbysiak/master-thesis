...
Dalszą analizę wpływu poszczególnych zmiennych przeprowadzono przy użyciu wykresów zależności cząstkowej \angterm{partial dependence plots}. Ze względu na wysoki koszt obliczeniowy tej metody, przedstawione wyniki wyjątkowo nie były powtarzane i uśredniane.
