...
W symulacjach zderzeń użyty był symulator \texttt{Pythia8} (\textit{tune: Pythia8Jets\_Monash2013}), następnie przy pomocy \texttt{Geant3} symulowany był transport cząstek i odpowiedź detektora ALICE. 
