...
Istnieje twierdzenie o sieciach neuronowych jako uniwersalnych aproksymatorach funkcji \angterm{Universal approximation theorem}, mówiące, że już sieć neuronowa o jednej warstwie ukrytej jest zdolna do przybliżenia dowolnej funkcji z dowolną dokładnością. Twierdzenie to milczy niestety na temat liczby potrzebnych neuronów a przede wszystkim sposobu ich trenowania. 
...
\subsubsection*{Hiperparametry i trenowanie sieci neuronowych}
...
\begin{itemize}
	...
	\item opcjonalnie: warunki stopu \angterm{early stopping} w razie osiągnięcia \textit{plateau}
