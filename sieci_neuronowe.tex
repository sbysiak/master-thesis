...
Istnieje twierdzenie o sieciach neuronowych jako uniwersalnych aproksymatorach funkcji \angterm{Universal approximation theorem} \cite{hornik91}, mówiące, że już sieć neuronowa o jednej warstwie ukrytej jest zdolna do przybliżenia dowolnej funkcji z dowolną dokładnością. Twierdzenie to milczy niestety na temat liczby potrzebnych neuronów a przede wszystkim sposobu ich trenowania. 
